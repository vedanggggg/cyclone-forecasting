...
name = "*"
extracted_paths = glob.glob(f"/rds/general/user/zr523/home/researchProject/satellite/msg/data/native/{name}/*.nat")
...
zip_files = glob.glob(f"/rds/general/user/zr523/home/researchProject/satellite/msg/data/zip/{name}/*.zip")
pool = Pool(cpu_count())
zip_func = partial(extract_files_with_extension, 
                   target_extension = '.nat', 
                   extraction_path = '/rds/general/user/zr523/home/researchProject/satellite/msg/data/native/')
